...
If a template doesn't expecify a base template it inherits from the default **standard templates**. Which means that **explicity or implicity** all data templates inherit from the **standard templates**.
